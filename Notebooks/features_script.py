...
if __name__ == "__main__":
    # males_audio_files =list(pd.read_csv('males.csv')['path'])
    females_audio_files = list(pd.read_csv('females.csv')['path'])
    twenties_audio_files = list(pd.read_csv('twenties.csv')['path'])
    fifties_audio_files = list(pd.read_csv('fifties.csv')['path'])
    ...
    process_and_save_in_batches(twenties_audio_files,"twenties_general")
    process_and_save_in_batches(fifties_audio_files,"fifties_general")
